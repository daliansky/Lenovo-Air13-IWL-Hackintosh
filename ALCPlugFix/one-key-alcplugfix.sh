...
function download(){
    ...
    echo "正在下载声卡修复文件..."
    curl -fsSL https://raw.githubusercontent.com/daliansky/Lenovo-Air13-IWL-Hackintosh/master/ALCPlugFix/ALCPlugFix -O || networkWarn
    curl -fsSL https://raw.githubusercontent.com/daliansky/Lenovo-Air13-IWL-Hackintosh/master/ALCPlugFix/good.win.ALCPlugFix.plist -O || networkWarn
    curl -fsSL https://raw.githubusercontent.com/daliansky/Lenovo-Air13-IWL-Hackintosh/master/ALCPlugFix/hda-verb -O || networkWarn
    echo "下载完成"
    echo
}
