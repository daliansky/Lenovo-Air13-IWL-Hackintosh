...
sudo mkdir /Library/Logs/ALCPlugFix
...
sudo cp -f "$path/Config.plist" /Library/Preferences/ALCPlugFix
...
sudo cp -f "$path/com.black-dragon74.ALCPlugFix.plist" /Library/LaunchDaemons
